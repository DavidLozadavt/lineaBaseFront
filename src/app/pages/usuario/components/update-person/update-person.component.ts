...
export class UpdatePersonComponent {
  ...
  getUsuario() {
    const nombre2Value = this.getControl('nombre2').value;
    const apellido2Value = this.getControl('apellido2').value;
    return {
      id: this.person?.id,
      ...
      nombre2: nombre2Value && nombre2Value !== "" ? nombre2Value.toUpperCase() : "",
      apellido1: this.getControl('apellido1').value.trim().toUpperCase(),
      apellido2: apellido2Value && apellido2Value !== "" ? apellido2Value.toUpperCase() : "",
